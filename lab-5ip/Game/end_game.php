...
<section id="works">
    <h1>Игра: змейка</h1>
    <div id="show" style="font-size: 16px; color: #222222">
        "Вы проиграли!<br /> <u>Ваш счет:</u> <b>"+score+"</b><br><br> Не сдавайся, попробуйту еще раз!<br><br><input type='button' value='Play Again' onclick='window.location.reload();' />"
    </div>
